    ...
    >
      ...
      {(user?.role === "OWNER" || user?.role === "MANAGER") && (
        <div className="p-4 border-t border-slate-800 space-y-2">
          <a
            href={typeof window !== "undefined" ? `${window.location.protocol}//admin.${window.location.host.split(".").slice(-2).join(".")}/businesses` : "/admin/businesses"}
            className="flex items-center gap-3 px-4 py-2 text-sm font-medium text-slate-300 hover:bg-slate-800/50 rounded transition"
          >
